...
from .serializers import (
    ...
    BusSerializer, PaymentInitializationSerializer
)
...
class BookingViewSet(viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        # Use serializer to handle creation, setting status to pending
...
#                 booking.status = 'confirmed'
#                 booking.save()
#                 # Redirect to frontend ticket page with booking_id
#                 frontend_url = f'http://localhost:3000/ticket?booking_id={booking.id}'
#                 return HttpResponseRedirect(frontend_url)
#             else:
#                 booking.payment_status = 'failed'
#                 booking.status = 'cancelled'
