...
const faqData = {
  General: [
    { question: "Why book bus tickets online on FlexiRyde??", answer: "Booking bus tickets on FlexiRyde is the smarter way to travel. Skip long queues and book from anywhere with just a few clicks. Compare bus schedules, choose your preferred seats, and enjoy exclusive discounts. Secure payments ensure your transactions are safe, while real-time updates keep you informed about any schedule changes. Plus, check onboard amenities before booking for a more comfortable journey. Travel smarter with FlexiRyde!" },
    { question: "What are the advantages of purchasing a bus ticket with FlexiRyde?", answer: "You get seamless booking, digital tickets, and easy rescheduling." },
    {question: "Do I need to create an account on FlexiRyde to book my bus ticket?", answer: "No, you don’t have to create an account on FlexiRyde to book your bus ticket. But it is advisable to make one to accelerate the process next time you want to book bus tickets and help you modify your booking."},
    {question: "Does bus booking online cost me more?", answer: "Not at all! The bus ticket price is the same as you would get from the park by going there physically. FlexiRyde reduces the travel budget by comparing the bus ticket prices among various operators, making it a more cost-effective choice. Therefore, online bus booking is increasingly recognized as a more convenient, efficient, and economical mode of securing travel arrangements."},
  ],
  "Ticket-related": [
    {question: "How can I book bus tickets on FlexiRyde?", answer: "Bus ticket Booking is effortless on FlexiRyde. To book the bus tickets, go to the main page and enter your source city and destination city in the “From” and “To” fields, respectively. Enter the travel date and hit the check availability button. "},
  ...
  Payment: [
    ...
    { question: "Is my payment secure on FlexiRyde?", answer: "Yes, all payments are processed through secure gateways like Paystack and Opay, ensuring data encryption and fraud protection." },
    { question: "Does FlexiRyde charge any extra fees for online payments??", answer: "FlexiRyde does not charge additional booking fees. However, your payment provider may apply standard transaction fees." },
    ...
    { question: "Do I get a receipt after making a payment?", answer: "Yes, after a successful transaction, you will receive an email confirmation with your e-receipt and booking details. You can also access your booking history in your FlexiRyde account." },
  ],
  ...
  "Rescheduling": [
    ...
    { 
      ...
      answer: "Log into your FlexiRyde account, go to 'Change Travel Date,' select the trip you want to reschedule, and choose a new date and time." 
    },
    { 
