    ...
    <footer className="bg-gray-100 py-10 text-gray-700 text-sm">
      ...
      <div className="max-w-6xl mx-auto mt-10 px-6 flex flex-col md:flex-row justify-between items-center border-t pt-6">
        ...
        <div className="flex space-x-4 mt-4 md:mt-0">
          ...
          <FaInstagram className="text-gray-500 hover:text-pink-500 cursor-pointer" size={18} />
          <FaYoutube className="text-gray-500 hover:text-red-600 cursor-pointer" size={18} />
        </div>
      </div>
    </footer>
  );
